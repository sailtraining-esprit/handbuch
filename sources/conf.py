...
master_doc = 'Sicherheitshandbuch'
...
htmlhelp_basename = 'Betriebssicherheitshandbuch'
...
latex_documents = [
    (master_doc, 'Sicherheitshandbuch.tex', 'Esprit Betriebssicherheitshandbuch',
     'Jugendkutterwerk e.V.', 'manual'),
]
...
man_pages = [
    (master_doc, 'sicherheitshandbuch', 'Esprit Betriebssicherheitshandbuch',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Sicherheitshandbuch', 'Esprit Betriebssicherheitshandbuch',
     author, 'Sicherheitshandbuch', 'Betriebssicherheitshandbuch der Schoneryacht Esprit',
     'Miscellaneous'),
]
